...
> 目标读者：已经用 dsh 或同类 CLI agent 做过真实项目，但每次开新会话都要重新解释一遍项目约定的人。<br>
> 前置知识：知道 agent preset 大概是“给某个会话换一套工具和提示词”，不需要读过 dsh 源码。<br>
> 示例来源：本文机制部分以一个真实开源预设为例，机器相关路径已全部占位符化。<br>
> 本文核查时间：2026-09-13。
